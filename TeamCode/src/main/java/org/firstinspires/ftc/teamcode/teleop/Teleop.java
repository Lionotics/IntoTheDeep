...
public class Teleop extends NextFTCOpMode {
    ...
    public void onStartButtonPressed() {
     ...
     //   gp1.getRightBumper().setReleasedCommand( ()->Intake.INSTANCE.stopMovingGrabber() );
    ...
    public void onUpdate() {
        ...
        telemetry.addData("How Many Down: ", Elbow.howManyDownPressed);
        telemetry.addData("Elbow Is Up (intenral)",Elbow.INSTANCE.isUp);
        telemetry.update();
    }
}
